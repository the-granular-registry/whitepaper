...
* [Methodology](methodology/README.md)
  ...
  * [Generation](methodology/generation/README.md)
    * [Process](methodology/generation/process/README.md)
      * [Data Collection](methodology/generation/process/data-collection.md)
      * [EAC Registry Integration](methodology/generation/process/eac-registry-integration.md)
      * [Meter Data Quality Checks](methodology/generation/process/meter-data-quality-checks.md)
      * [Project Impact Report](methodology/generation/process/project-impact-report.md)
      * [Project Onboarding](methodology/generation/process/project-onboarding.md)
      * [Splitting PECs into Smaller Quantities](methodology/generation/process/splitting-pecs-into-smaller-quantities.md)
      * [Split Meter Data](methodology/generation/process/split-meter-data/README.md)
        * [Assign EAC IDs and PEC IDs](methodology/generation/process/split-meter-data/assign-eac-ids-and-pec-ids.md)
...
* [FAQ](faq/README.md)
  ...
  * [Can GCs be issued for carbon‑free generators that do not receive EACs?](faq/can-gcs-be-issued-for-carbon-free-generators-that-do-not-receive-eacs.md)
...
* [User Guide](user guide/README.md)
  ...
  * [GC Issuance](user guide/gc-issuance.md)
  * [GC Trading and Transfer](user guide/gc-trading-and-transfer.md)
  * [GC Retirement](user guide/gc-retirement.md)
  * [Standard Supply Service (SSS) Module](user guide/standard-supply-service-sss-module.md)
  * [Registration, Login, and Admin](user guide/registration-login-and-admin/README.md)
    * [Registration](user guide/registration-login-and-admin/registration.md)
    * [User Identification](user guide/registration-login-and-admin/user-identification.md)
    * [Login](user guide/registration-login-and-admin/login.md)
    * [Additional Users](user guide/registration-login-and-admin/additional-users.md)
    * [Removing your company and all accounts from the Registry](user guide/registration-login-and-admin/removing-your-company-and-all-accounts-from-the-registry.md)
  * [Registry Users](user guide/registry-users.md)
  * [Public Retirement Table](user guide/public-retirement-table.md)
  * [Billing](user guide/billing.md)
  * [Help Desk](user guide/help-desk.md)
  * [Glossary](user guide/glossary.md)
  * [Fee Structure](user guide/fee-structure.md)
  * [accounts](user guide/accounts/README.md)
    * [Internal Accounts Subaccounts](user guide/accounts/internal-accounts-subaccounts.md)
    * [Beneficiary Allocation Sub-Accounts](user guide/accounts/beneficiary-allocation-sub-accounts.md)
  * [Reporting Module Overview](user guide/reporting-module-overview.md)